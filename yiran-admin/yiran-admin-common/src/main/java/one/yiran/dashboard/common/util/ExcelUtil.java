        ...
        if (rows > 0) {
            ...
            for (int col = 0; col < allFields.length; col++) {
                ...
                if (attr != null && (attr.type() == Excel.Type.ALL || attr.type() == type)) {
                    ...
                    if (column == null) {
                        throw BusinessException.build("导入的Excel缺少列:" + attr.name());
                    }
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (StringUtils.endsWith(s, ".0")) {
                            ...
                            {
                                val = one.yiran.common.util.DateUtil.parseDateToStr(dateFormat, (Date) val);
                            }
                            else
                            {
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(one.yiran.common.util.DateUtil.parseDateToStr(dateFormat, (Date) value));
                }
