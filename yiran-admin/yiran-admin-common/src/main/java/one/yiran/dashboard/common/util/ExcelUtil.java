...
import one.yiran.dashboard.common.annotation.Excel.Type;
import one.yiran.dashboard.common.annotation.Excels;
            ...
            for (int i = titleNum + 1; i <= rows; i++)
            {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet())
                {
                    ...
                    else if (Date.class == fieldType)
                    {
                        ...
                        {
                            val = one.yiran.common.util.DateUtil.parseDate(val);
                        }
...
//                        }
                        else if (Excel.ColumnType.IMAGE == attr.cellType() &&  pictures != null && pictures.size() > 0)
                        {
                            ...
                            else
                            {
                                ...
                                val = FileUtil.writeImportBytes(data);
                            }
                        }
    ...
    private Map<String, CellStyle> annotationHeaderStyles(Workbook wb, Map<String, CellStyle> styles)
    {
        ...
        {
            Excel excel = (Excel) os[1];
            String key = String.format("header_%s_%s", excel.headerColor(), excel.headerBackgroundColor());
    ...
    private Map<String, CellStyle> annotationDataStyles(Workbook wb)
    {
        ...
        {
            Excel excel = (Excel) os[1];
            String key = String.format("data_%s_%s_%s", excel.align(), excel.color(), excel.backgroundColor());
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                cell.setCellStyle(styles.get(String.format("data_%s_%s_%s", attr.align(), attr.color(), attr.backgroundColor())));
...
//    }
    ...
    {
        String downloadPath = Global.getUploadPath() + filename;
    ...
    public String parseDateToStr(String dateFormat, Object val)
    {
        ...
        {
            str = one.yiran.common.util.DateUtil.parseDateToStr(dateFormat, (Date) val);
        }
        else if (val instanceof LocalDateTime)
        {
            str = one.yiran.common.util.DateUtil.parseDateToStr(dateFormat, one.yiran.common.util.DateUtil.toDate((LocalDateTime) val));
        }
        else if (val instanceof LocalDate)
        {
            str = one.yiran.common.util.DateUtil.parseDateToStr(dateFormat, one.yiran.common.util.DateUtil.toDate((LocalDate) val));
        }
        else
        {
            str = val.toString();
